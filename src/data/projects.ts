...
export const projects: Project[] = [
  ...
  },
  {
    ...
    screenshots: ["/images/capy-bridge-hero.png", "/images/capy-bridge-architecture.png", "/images/capy-bridge-steps.png"],
    caseStudy: {
  ...
  },
  {
    ...
    screenshots: ["/images/contract-first-mascot.png"],
    caseStudy: {
  ...
  },
  {
    ...
    screenshots: ["/images/forge-mascot.png"],
    caseStudy: {
  ...
  // ─── TIER 3 ───
  { slug: "short-movie-maker", name: "Short Movie Maker", tagline: "End-to-end AI film production pipeline.", tier: 3, description: "Generate narrative films from a single paragraph.", keyMetric: { value: "1 paragraph", label: "to film" }, categories: ["video"], github: [{ owner: "ndpvt-web", repo: "short-movie-maker" }], screenshots: [] },
  { slug: "navi", name: "NAVI", tagline: "Blind navigation assistant, sub-$50 hardware.", tier: 3, description: "Sensor fusion for real-time navigation assistance.", keyMetric: { value: "<$50", label: "hardware cost" }, categories: ["infra"], github: [{ owner: "ndpvt-web", repo: "navi" }], screenshots: ["/images/navi-architecture.png"] },
  ...
  { slug: "deeptutor", name: "DeepTutor", tagline: "AI-powered personalized tutoring system.", tier: 3, description: "Adaptive learning with knowledge graph.", keyMetric: { value: "Adaptive", label: "learning" }, categories: ["education"], github: [{ owner: "ndpvt-web", repo: "deeptutor-claude-skill" }], screenshots: [] },
  { slug: "copycapy", name: "CopyCapy", tagline: "Clone any website into production-grade code.", tier: 3, description: "Website to codebase transformation.", keyMetric: { value: "1-click", label: "clone" }, categories: ["automation"], github: [{ owner: "ndpvt-web", repo: "copycapy" }], screenshots: ["/images/copycapy-hero.png"] },
  { slug: "oss-contributor-swarm", name: "OSS Contributor Swarm", tagline: "Autonomous 10-agent open source contributor.", tier: 3, description: "Discover, implement, submit PRs autonomously.", keyMetric: { value: "10 agents", label: "autonomous" }, categories: ["agents"], github: [{ owner: "niveshdandyan", repo: "oss-contributor-swarm" }], screenshots: [] },
  { slug: "agent-architect", name: "Agent Architect", tagline: "Meta-agent that designs optimal agent swarms.", tier: 3, description: "Designs and orchestrates agent configurations.", keyMetric: { value: "Auto-design", label: "swarms" }, categories: ["agents"], github: [{ owner: "niveshdandyan", repo: "agent-architect-skill" }], screenshots: [] },
  { slug: "generational-succession", name: "Generational Agent Succession", tagline: "Parallel agents with generational handoff.", tier: 3, description: "Knowledge transfer across agent generations.", keyMetric: { value: "Generational", label: "learning" }, categories: ["agents"], github: [{ owner: "niveshdandyan", repo: "generational-agent-succession" }], screenshots: [] },
  { slug: "llm-council", name: "LLM Council", tagline: "Multi-model consensus with live dashboard.", tier: 3, description: "Query multiple AI models with voting.", keyMetric: { value: "6 models", label: "consensus" }, categories: ["research"], github: [{ owner: "niveshdandyan", repo: "llm-council" }], screenshots: [] },
  { slug: "skill-tester-swarm", name: "Skill Tester Swarm", tagline: "Industrial QA for Claude Code skills.", tier: 3, description: "LLM Council evaluation system.", keyMetric: { value: "Industrial", label: "QA" }, categories: ["agents"], github: [{ owner: "niveshdandyan", repo: "skill-tester-swarm" }], screenshots: [] },
  { slug: "viral-video-gen", name: "Viral Video Generator", tagline: "End-to-end AI video production pipeline.", tier: 3, description: "Complete vertical video generation.", keyMetric: { value: "End-to-end", label: "pipeline" }, categories: ["video"], github: [{ owner: "niveshdandyan", repo: "viral-video-generator" }], screenshots: [] },
  { slug: "swarm-dashboard", name: "Swarm Dashboard", tagline: "Real-time monitoring for AI agent swarms.", tier: 3, description: "Live agent status and coordination view.", keyMetric: { value: "Real-time", label: "monitoring" }, categories: ["infra"], github: [{ owner: "niveshdandyan", repo: "swarm-dashboard" }], screenshots: [] },
  { slug: "teammate-tool", name: "Teammate Tool", tagline: "Native agent coordination for Claude Code.", tier: 3, description: "TeamCreate-based multi-agent orchestration.", keyMetric: { value: "Native", label: "coordination" }, categories: ["agents"], github: [{ owner: "niveshdandyan", repo: "teammate-tool" }], screenshots: [] },
  { slug: "happycapy-design", name: "HappyCapy Design System", tagline: "Capybara-inspired UI design language.", tier: 3, description: "Component library and design tokens.", keyMetric: { value: "Design", label: "system" }, categories: ["infra"], github: [{ owner: "niveshdandyan", repo: "happycapy-design" }], screenshots: [] },
  { slug: "factorized-video-gen", name: "Factorized Video Gen", tagline: "Decomposed video generation pipeline.", tier: 3, description: "Based on arxiv:2512.16371.", keyMetric: { value: "Factorized", label: "pipeline" }, categories: ["video", "research"], github: [{ owner: "niveshdandyan", repo: "factorized-video-gen" }], screenshots: [] },
  { slug: "revision-dojo", name: "Revision Dojo", tagline: "Template-driven revision system.", tier: 3, description: "Structured revision workflow.", keyMetric: { value: "Template", label: "driven" }, categories: ["education"], github: [{ owner: "ndpvt-web", repo: "revision-dojo-template" }], screenshots: [] },
  { slug: "arxiv-claude-skills", name: "arXiv Claude Skills", tagline: "Research paper analysis skills.", tier: 3, description: "Parse and analyze arXiv papers.", keyMetric: { value: "arXiv", label: "analysis" }, categories: ["research"], github: [{ owner: "ndpvt-web", repo: "arxiv-claude-skills" }], screenshots: [] },
];
